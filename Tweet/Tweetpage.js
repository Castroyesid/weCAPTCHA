...
let u6= {
    user: "Massimo",
    uname: "@Rainmaker1973",
    tval: "What’s this abouOn Valentine's Day, exactly 31 years ago, cruising four billion miles from the Sun, the Voyager 1 spacecraft looked back one last time to make the first ever Solar System family portrait. 31 years later, look again at the Pale Blue Dot [read more: https://buff.ly/2SqOkst]st new variants",
    valt: "Hvað er þetÁ Valentínusardaginn, fyrir nákvæmlega 31 ári, þegar hann sigldi fjórum milljörðum mílna frá sólinni, leit Voyager 1 geimfarið í síðasta skipti til baka til að gera fyrstu fjölskyldumynd Sólkerfisins. 31 árum seinna skaltu líta aftur á Fölbláa punktinn [lesa meira: https://buff.ly/2SqOkst]ta við ný afbrigði?r",
    l: 247,
    r: 82,
}
